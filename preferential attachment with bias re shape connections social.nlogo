...
to save-plots
  ...
  let z "plots.csv"
  let part1 word x y
  let settings word bias social-bias
...
<experiments>
  <experiment name="experiment" repetitions="10" runMetricsEveryStep="false">
    ...
    <timeLimit steps="200"/>
    <metric>;show nw:biggest-maximal-clique</metric>
    <steppedValueSet variable="social-bias" first="0" step="20" last="100"/>
    <steppedValueSet variable="bias" first="0" step="20" last="100"/>
  ...
  <experiment name="experiment" repetitions="10" runMetricsEveryStep="true">
    ...
    <final>save-plots</final>
    <timeLimit steps="50"/>
    <exitCondition>count turtles &gt; 200</exitCondition>
    <metric>count turtles</metric>
    <enumeratedValueSet variable="number-of-nodes">
      <value value="20"/>
    </enumeratedValueSet>
    <steppedValueSet variable="bias" first="1" step="20" last="100"/>
    <steppedValueSet variable="social-bias" first="1" step="20" last="100"/>
    <enumeratedValueSet variable="plot?">
      <value value="true"/>
    </enumeratedValueSet>
  </experiment>
